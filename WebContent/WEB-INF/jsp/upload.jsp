...
<html lang="en">
    <head>
		...
		<link href="${pageContext.request.contextPath}/resources/template/css/dropzone.css" rel="stylesheet" />
    ...
    <body>
					...
					<div class="contentpanel">
						<div class="row row-stat">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">Upload files to the cloud</h4>
                            </div>
                            <div class="panel-body">
                                <p>.</p>
                                <br />
                                <form action="${pageContext.request.contextPath}/upload" class="dropzone" id="filedropzone">
        ...
        <script src="${pageContext.request.contextPath}/resources/template/js/jquery-ui-1.10.3.min.js"></script>
		...
		<script src="${pageContext.request.contextPath}/resources/template/js/dropzone.min.js"></script>
        <script src="${pageContext.request.contextPath}/resources/template/js/custom.js"></script>
        
		<script src="${pageContext.request.contextPath}/resources/custom/js/uploadspage.js"></script>
